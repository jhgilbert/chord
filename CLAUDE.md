...
After making UI changes that affect user-facing behavior, remind the user that the following may need updating:
...
If the user asks you to update them, also regenerate the test screenshots by running:
