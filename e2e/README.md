...
![Retro preset selected](collaboration.spec.ts-snapshots/changed-preset-chromium-darwin.png)

The host switches back to Discussion and fills in the prompt: *"What should we have for dinner? All ideas are welcome."*

![Completed start screen](collaboration.spec.ts-snapshots/completed-start-screen-chromium-darwin.png)
...
![Empty collaboration](collaboration.spec.ts-snapshots/new-active-empty-collaboration-chromium-darwin.png)

## Participants joining

Three participants (Frank, Alfie, and Evey) open the share link. They land in a waiting room until the host approves them.

![Participants awaiting approval](collaboration.spec.ts-snapshots/participants-awaiting-approval-chromium-darwin.png)

The host uses **Select all** and **Admit selected** to let everyone in at once.

![Participants accepted](collaboration.spec.ts-snapshots/participants-accepted-chromium-darwin.png)
...
![Participant views all notes](collaboration.spec.ts-snapshots/participant-alfie-views-all-notes-chromium-darwin.png)
...
![Host prepares poll](collaboration.spec.ts-snapshots/host-prepares-poll-chromium-darwin.png)
...
![Host views poll results](collaboration.spec.ts-snapshots/host-views-poll-results-chromium-darwin.png)

Participants also see the results while the collaboration is paused.

![Participant views poll results](collaboration.spec.ts-snapshots/participant-views-poll-results-chromium-darwin.png)

## Upvotes and sorting

Notes can be upvoted by any participant. The host can sort by **Most upvotes** to surface the most popular ideas.

![Host views upvotes sorted](collaboration.spec.ts-snapshots/host-views-upvotes-chromium-darwin.png)
...
![Participant final view](collaboration.spec.ts-snapshots/participant-view-final-chromium-darwin.png)
...
![Users page](collaboration.spec.ts-snapshots/collab-users-page-chromium-darwin.png)
...
![Final report - host view](collaboration.spec.ts-snapshots/collab-final-report-host-view-chromium-darwin.png)

Participants with access see the same report.

![Final report - participant view](collaboration.spec.ts-snapshots/collab-final-report-participant-view-chromium-darwin.png)
